 ...
 * This file demonstrates how to integrate Defiswap with a web frontend
 */

// For React/Vue/Angular applications
export class DefiswapClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DefiswapClient(provider, contractAddress);
